...
class Items {
  ...
  Items({this.boostUnavailableIdentifier, this.boostUnavailableReason, this.canReshare, this.canSave, this.caption, this.captionIsEdited, this.carouselMedia, this.carouselMediaCount, this.carouselMediaIds, this.carouselMediaPendingPostCount, this.clipsTabPinnedUserIds, this.coauthorProducers, this.code, this.commentCount, this.commentInformTreatment, this.commentThreadingEnabled, this.commercialityStatus, this.deletedReason, this.deviceTimestamp, this.fbAggregatedCommentCount, this.fbAggregatedLikeCount, this.fbid, this.featuredProducts, this.filterType, this.fundraiserTag, this.hasLiked, this.hasMoreComments, this.hasPrivatelyLiked, this.hasSharedToFb, this.id, this.igMediaSharingDisabled, this.igbioProduct, this.imageVersions, this.inlineComposerDisplayCondition, this.inlineComposerImpTriggerTime, this.integrityReviewDecision, this.invitedCoauthorProducers, this.isAutoCreated, this.isCommentsGifComposerEnabled, this.isCutoutStickerAllowed, this.isEligibleForMediaNoteRecsNux, this.isInProfileGrid, this.isOpenToPublicSubmission, this.isOrganicProductTaggingEligible, this.isPaidPartnership, this.isPinned, this.isPostLiveClipsMedia, this.isQuietPost, this.isReshareOfTextPostAppMediaInIg, this.isReuseAllowed, this.isSocialUfiEligible, this.isTaggedMediaSharedToViewerProfileGrid, this.isUnifiedVideo, this.isVideo, this.likeAndViewCountsDisabled, this.likeCount, this.location, this.maxNumVisiblePreviewComments, this.mediaName, this.mediaType, this.mezqlToken, this.musicMetadata, this.openCarouselSubmissionState, this.originalHeight, this.originalWidth, this.owner, this.previewComments, this.productSuggestions, this.productType, this.shareCountDisabled, this.sharingFrictionInfo, this.shopRoutingUserId, this.shouldShowAuthorPogForTaggedMediaSharedToProfileGrid, this.socialContext, this.sponsorTags, this.subscribeCtaVisible, this.taggedUsers, this.takenAt, this.takenAtTs, this.thumbnailUrl, this.timelinePinnedUserIds, this.topLikers, this.user});
  ...
  Items.fromJson(Map<String, dynamic> json) {
    ...
    if(json["fb_user_tags"] is Map) {
      //fbUserTags = json["fb_user_tags"] == null ? null : FbUserTags1.fromJson(json["fb_user_tags"]);
    }
    ...
    if(json["is_social_ufi_eligible"] is bool) {
      isSocialUfiEligible = json["is_social_ufi_eligible"];
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["is_social_ufi_eligible"] = isSocialUfiEligible;
  ...
  Items copyWith({
    ...
    isSocialUfiEligible: isSocialUfiEligible ?? this.isSocialUfiEligible,
